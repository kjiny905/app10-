...
@Slf4j
@SpringBootTest
@TestMethodOrder(MethodOrderer.OrderAnnotation.class)  //메소드를 수행하는데있어 순서를 준다
public class ProductDAOImplTest2 {
  @Autowired
  private ProductDAO productDAO;
  private static final int COUNT = 3;
  private static List<Long> productIds = new ArrayList<>(); //상품번호만 담을 수 있는 컬렉션
  ...
  void save(){
    ...
    for(int i=1; i<COUNT; i++) {
      products.add(new Product(null, "노트북1" + 1, 1L * i, 1000000L * i));
    }
